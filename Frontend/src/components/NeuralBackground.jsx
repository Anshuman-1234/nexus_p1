    ...
    useEffect(() => {
        ...
        class Particle {
            constructor() {
                ...
                this.type = Math.random() > 0.85 ? 'book' : 'circle'; // 15% chance to be a book
                this.icon = ['📖', '📚', '📜'][Math.floor(Math.random() * 3)];
            ...
            draw() {
                if (this.type === 'book') {
                    ...
                    ctx.fillStyle = 'rgba(255, 255, 255, 0.6)'; // Higher opacity for icons
